...
<script>
$(function(){
	$(document.reviewUpdateFrm).submit(reviewValidate);	
});
	...
	<form
		...
		<tr>
			<td style="text-align:center">
				...
				<img src="<%= request.getContextPath() %>/upload/review/<%= review.getReviewphoto().getPhotoRenamedFilename()%>" id='reviewphotoid' border='0' onclick='document.all.reviewphoto.click()' width="300px" height="300px">
		     	<% 
		     		} 
		     	%>
		     	<% if(review.getReviewphoto() == null){ %>
