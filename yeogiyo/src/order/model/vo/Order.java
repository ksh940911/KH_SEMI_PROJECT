...
public class Order {
	...
	public String toString() {
		return "Order [orderId=" + orderId + ", memberId=" + memberId + ", resId=" + resId + ", orderDate=" + orderDate
				+ ", address=" + address + ", addressSub=" + addressSub + ", phone=" + phone + ", orderComment="
				+ orderComment + ", paymentWay=" + paymentWay + ", paymentPlace=" + paymentPlace + ", orderMenu="
				+ orderMenu + ", totalPrice=" + totalPrice + ", reviewYN=" + reviewYN + "]";
	}
